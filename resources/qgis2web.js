...
map.getView().fit([11061936.339058, -296853.976053, 13320169.993421, 1236764.996557], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">MALARIA CASES IN MALAYSIA WITHIN 2021-2022</h2>';
        return titleElement;
    })(),
